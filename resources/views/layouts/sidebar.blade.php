        ...
        <ul class="metismenu" id="menu">
            ...
            <li class="Ul_li--hover"><a class="{{ Request::is('company-setting') ? 'sidebar_active' : '' }}"
                    href="{{ url('company-setting') }}"><i class="fa fa-cogs mr-2 text-muted" style="font-size:20px;"></i><span
                        class="item-name text-15 text-muted">Bank & Cash Accounts</span></a>
            </li>
            @endcan
            @can('accounting_access')
            <li class="Ul_li--hover {{ Request::is('journals*') | Request::is('journal-entries*') | Request::is('customer-payment*') | Request::is('supplier-payment*') ? 'mm-active' : '' }}">
            ...
            @endcan
            @can('sales_access')
            <li class="Ul_li--hover {{ (Request::is('customers*') | Request::is('sale*') || Request::is('other-sale*') || Request::is('diamond-sale*') || Request::is('sale-order*') )? 'mm-active' : '' }}">
            ...
            <li class="Ul_li--hover"><a class="{{ Request::is('gold-rate') ? 'sidebar_active' : '' }}"
                    href="{{ url('gold-rate') }}"><i class="fa fa-bar-chart mr-2 text-muted" style="font-size:20px;"></i><span
