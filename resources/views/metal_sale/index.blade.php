            ...
            <div class="col-md-12 mb-4">
                <div class="card text-left">
                    <div class="card-header text-right bg-transparent">
                        @can('metal_sale_create')
                        <a class="btn btn-primary btn-md m-1" href="{{ url('metal-sale/create') }}"><i
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8" id="div_post_metal_sale">
                                ...
                                <a class="btn btn-danger" style="color:#fff;" type="button" id="unselectAll">Uncheck
                                    All</a>
                                @can('metal_sale_post')
                                <a class="btn btn-primary" style="color:#fff;" type="button" id="post_metal_sale">Post</a>
                                @endcan
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="metal_sale_table" class="display table" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th>Sr#</th>
...
@include('metal_sale/Modal/PaymentModel')
...
{data: 'metal_sale_date', name: 'metal_sale_date', orderable: false, searchable: false},
{data: 'metal_sale_no', name: 'metal_sale_no', orderable: false, searchable: false},
...
'route' => 'metal-sale/data',
'buttons' => false,
'pageLength' => 50,
'class' => 'metal_sale_table',
'variable' => 'metal_sale_table',
'datefilter' => true,
...
<script type="text/javascript">
    $('#search_button').click(function() {
        $("#preloader").show();
        initDataTablemetal_sale_table();
        $("#div_post_metal_sale").show();
        $("#preloader").hide();
    });
    ...
    $("body").on("click", "#createNewPayment", function() {
        ...
        $("#saveBtn").show();
        $("#metal_sale_id").val($(this).data("metal_sale_id"));
        ...
        GetMetalSaleDetailById($(this).data("metal_sale_id"));
    });

    function GetMetalSaleDetailById (metal_sale_id) {
        $("#preloader").show();
        $.ajax({
            url: "{{url('metal-sale/get-metal-sale-detail-by-id')}}/" + metal_sale_id,
            type: "GET",
            headers: {
                "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
            },
    ...
    $("body").on("keyup", "#advance_amount,#cash_amount,#bank_transfer_amount,#card_amount", function(event) {
    ...
    $("body").on("click", "#paymentSave", function(e) {
        ...
        formData.append("metal_sale_id", $("#metal_sale_id").val());
        ...
        $.ajax({
            url: "{{ url('metal-sale/metal-sale-payment')}}",
            type: "POST",
            headers: {
                "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
            },
    ...
    $("#post_metal_sale").click(function() {
        $("#preloader").show();
        ...
        if (sales.length <= 0) {
            ...
            $.ajax({
                url: "{{ url('metal-sale/post-metal-sale') }}",
                type: "POST",
                headers: {
                    "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
                },
    ...
    $("body").on("click", "#unpost_metal_sale", function() {
        $("#preloader").show();
        var sale_id = $(this).data("id");

        $.ajax({
            url: "{{ url('metal-sale/unpost-metal-sale') }}/" + sale_id,
            type: "GET",
            headers: {
                "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
            },
    ...
    $("body").on("click", "#deleteMetalSale", function() {
        var metal_sale_id = $(this).data("id");
        Swal.fire({
            title: "Are you sure?",
            ...
            if (result.isConfirmed) {
                $.ajax({
                        type: "get",
                        url: "{{ url('metal-sale/destroy') }}/" + metal_sale_id,
                    }).done(function(data) {
                        if ((data.Success = true)) {
                            $("#preloader").hide();
                            success(data.Message)
