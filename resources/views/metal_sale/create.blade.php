    ...
    <div class="row pl-2">
        ...
        <div class="col-md-4">
            <input type="text" name="sale_no" id="sale_no"
                value="{{ isset($metal_sale) ? $metal_sale->metal_sale_no : 'SL-05102024-0009' }}"
                ...
                <div class="card">
                    ...
                    <form id="saleForm" action="#" method="POST" enctype="multipart/form-data">
                        <div class="card-body" style="font-size: 14px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="metal_sale_date" id="metal_sale_date"
                                                    class="form-control"
                                                    value="{{ isset($metal_sale) ? $metal_sale->metal_sale_date : old('metal_sale_date') }}"
                                                    required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select id="select_tag_no" name="select_tag_no"
                                                    class="form-control show-tick">
                                                    @foreach ($metal_product as $item)
                                                    <option value="{{ $item->tag_no }}"
                                                        @if (isset($metal_sale)) {{ $metal_sale->metal_product_id == $item->id ? 'selected' : '' }} @endif>
                                                        {{ $item->tag_no ?? '' }}
                                                    </option>
                                                    @endforeach
                                                </select>
                            ...
                            <div class="row">
                                <input type="hidden" class="form-control" value="{{ isset($metal_sale) ? $metal_sale->id : '' }}"
                                    id="id" name="id">
                                <div class="col-md-12">
                                    <hr class="mb-2 mt-2">
                                    <b>Add Sale Detail:</b>
                                </div>
                                <input type="hidden" name="metal_product_id" id="metal_product_id" value="">
                                <input type="hidden" name="metal_purchase_id" id="metal_purchase_id" value="">
                                <input type="hidden" name="metal_purchase_detail_id" id="metal_purchase_detail_id" value="">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="form-label">Metal Rate:<span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="0" id="metal_rate"
                                            name="metal_rate" class="form-control"
                                            onkeypress="return isNumberKey(event)" required />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="form-label">Total Metal Amount:<span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="0" id="total_metal_amount"
                                            name="total_metal_amount" class="form-control"
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" name="grand_total"
                                                    value="{{ isset($metal_sale) ? $metal_sale->sub_total : '0' }}"
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" name="discount_amount"
                                                    value="{{ isset($metal_sale) ? $metal_sale->discount_amount : 0 }}"
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" name="grand_total_total"
                                                    value="{{ isset($metal_sale) ? $metal_sale->total : '0' }}"
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" name="advance_amount" readonly
                                                    value="{{ isset($metal_sale) ? $metal_sale->advance_amount : 0 }}"
                        ...
                        @include('metal_sale/Modal/AdvanceModel')
                    </form>
                </div>
                <!-- end of col -->
            </div>
...
@include('metal_sale/Modal/CustomerModal')
@include('metal_sale/Modal/BeadModal')
@include('metal_sale/Modal/DiamondModal')
@include('metal_sale/Modal/StonesModal')
@include('metal_sale/Modal/DetailModal')
{{-- @include('metal_sale/Modal/UsedGoldModal') --}}
@endsection
@section('js')
<script src="{{ url('metal-sale/js/metal_sale.js') }}"></script>
<script src="{{ url('metal-sale/js/beadWeight.js') }}"></script>
<script src="{{ url('metal-sale/js/stoneWeight.js') }}"></script>
<script src="{{ url('metal-sale/js/diamondCarat.js') }}"></script>
{{-- <script src="{{ url('metal-sale/js/usedGold.js') }}"></script> --}}
<script type="text/javascript">
    var url_local = "{{ url('/') }}";
    var metal_sale_id = "{{ isset($metal_sale) ? $metal_sale->id : '' }}";
...
<script>
    $(document).ready(function() {
        ...
        getCustomer();
        const metal_sale_date = document.getElementById("metal_sale_date");

        // ✅ Using the visitor's timezone
        metal_sale_date.value = formatDate();
        ...
        metal_sale_date.value = new Date().toISOString().split("T")[0];
    });
</script>
@endsection