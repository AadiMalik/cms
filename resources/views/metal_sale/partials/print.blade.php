                        ...
                        <div class="col-md-12">
                            ...
                            <div style="width: 100%;">
                                <div style="float: left; line-height: 25px; width:70%;">
                                    ...
                                    <b>{{ $metal_sale->customer_name ?? '' }}</b><br>
                                    <b>CNIC:</b> {{ $metal_sale->customer_cnic ?? '' }}<br>
                                    <b>Contact #:</b> {{ $metal_sale->customer_contact ?? '' }}<br>
                                    <b>Address:</b> {{ $metal_sale->customer_address ?? '' }}
                                </div>
                                <div style="float: right; line-height: 25px;">
                                    <b>Invoice No:</b> {{$metal_sale->metal_sale_no??''}} <br>
                                    <b>Date:</b> {{date("d M Y g:h:i A", strtotime(str_replace('/', '-', $metal_sale->metal_sale_date)))}} <br>
                                    <b>Created By:</b> {{$metal_sale->created_by->name??''}}
                                </div>
                            </div>
                            <br><br><br><br>
                            <table border="1" class="table" style="width: 100%;">
                                ...
                                <tbody>
                                    @foreach ($metal_sale_detail as $index=> $item)
                                    <tr>
                                        <td>{{$index+1}}</td>
                                        <td>
                                            <b>{{$item['tag_no']}} {{$item['product']}}</b><br>
                                            <small><b>Metal:</b>{{$item['metal']}}, <b>Scale Wt:</b>{{$item['scale_weight']}},
                                                <b>Net Wt:</b>{{$item['net_weight']}}, <b>Purity(%):</b>{{$item['purity']}},
                            ...
                            <div style="float: right;">
                                @php
                                $change = ($metal_sale->cash_amount + $metal_sale->bank_transfer_amount + $metal_sale->card_amount + $metal_sale->advance_amount + $metal_sale->gold_impure_amount) - $metal_sale->total;
                                @endphp
                                <table style="width: 300px; line-height: 30px;">
                                    <tbody>
                                        <tr>
                                            <td><b>Subtotal:</b></td>
                                            <td style="text-align: right;"><b>{{number_format($metal_sale->sub_total,2)}} PKR</b></td>
                                        </tr>
                                        <tr>
                                            <td><b>Discount:</b></td>
                                            <td style="text-align: right;"><b>{{number_format($metal_sale->discount_amount,2)}} PKR</b></td>
                                        </tr>
                                        <tr>
                                            <td><b>Total:</b></td>
                                            <td style="text-align: right;"><b>{{number_format($metal_sale->total,2)}} PKR</b></td>
                                        </tr>
                                        <tr>
                                            <td><b>Cash Amount</b></td>
                                            <td style="text-align: right;"><b>(-) {{number_format($metal_sale->cash_amount,2)}} PKR</b></td>
                                        </tr>
                                        <tr>
                                            <td><b>Bank Transfer</b></td>
                                            <td style="text-align: right;"><b>(-) {{number_format($metal_sale->bank_transfer_amount,2)}} PKR</b></td>
                                        </tr>
                                        <tr>
                                            <td><b>Card Amount</b></td>
                                            <td style="text-align: right;"><b>(-) {{number_format($metal_sale->card_amount,2)}} PKR</b></td>
                                        </tr>
                                        <tr>
                                            <td><b>Advance Amount</b></td>
                                            <td style="text-align: right;"><b>(-) {{number_format($metal_sale->advance_amount,2)}} PKR</b></td>
                                        </tr>
