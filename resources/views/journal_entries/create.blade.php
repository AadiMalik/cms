                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" id="balance"
                                    style="text-align:right; font-weight:bold; font-size:12px; font-family:tahoma; background: #f60a0a73; color: #000;border: 1px solid #ed0d0d;"
                                    class="form-control" value="" readonly>
                            </div>
                            <div class="col-md-2">
                                <label>AU Bal: </label>
                                <input type="text" id="balance_au"
                                    style="text-align:right; font-weight:bold; font-size:12px; font-family:tahoma; background: #f60a0a73; color: #000;border: 1px solid #ed0d0d;"
                                    class="form-control" value="" readonly>
                            </div>
                            <div class="col-md-2">
                                <label>Dollar Bal: </label>
                                <input type="text" id="balance_dollar"
                                    style="text-align:right; font-weight:bold; font-size:12px; font-family:tahoma; background: #f60a0a73; color: #000;border: 1px solid #ed0d0d;"
                                    class="form-control" value="" readonly>
                            </div>
                            <div class="col-md-3">
