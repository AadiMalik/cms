                                                ...
                                                <table class="table table-bordered">
                                                      <tbody>
                                                            ...
                                                            <tr>
                                                                  ...
                                                                  <td data-field="purity"></td>
                                                            </tr>
                                                            <tr>
                                                                  <td class="font-weight-bold">Metal Rate:</td>
                                                                  <td data-field="metal_rate"></td>
                                                                  <td class="font-weight-bold">Total Metal Price:</td>
                                                                  <td data-field="total_metal_amount"></td>
                                                            </tr>
                                                            <tr>
                                                                  <td class="font-weight-bold">Total Stones Price:</td>
                                                                  <td data-field="total_stones_amount"></td>
                                                                  <td class="font-weight-bold">Total Bead Price:</td>
                                                                  <td data-field="total_bead_amount"></td>
                                                            </tr>
                                                            <tr>
                                                                  <td class="font-weight-bold">Total Diamond Price:</td>
                                                                  <td data-field="total_diamond_amount"></td>
                                                                  <td class="font-weight-bold">Other Charges:</td>
                                                                  <td data-field="other_charges"></td>
                                                            </tr>
                                                            <tr>
...
<script>
      $(document).ready(function() {
            ...
            $(document).on('change', '#search', function() {
                  ...
                  $.ajax({
                        url: "/metal-product/fetch-search/" + id,
                        type: "GET",
                        success: function(response) {
                              console.log(response);
                              if (response.Success && response.Data) {
                                    let d = response.Data.metal_product || {};
                                    let beads = response.Data.metal_product_bead || [];
                                    let stones = response.Data.metal_product_stone || [];
                                    let diamonds = response.Data.metal_product_diamond || [];

                                    $('#dataContainer').removeClass('d-none');

                                    // Main product
                                    $("td[data-field='product']").text(d.product?.name ? d.product.name + ' ' + (d.product.prefix ?? '') : '');
                                    $("td[data-field='purchase']").text(d.metal_puchase?.metal_puchase_no ?? '');
                                    $("td[data-field='tag_no']").text(d.tag_no ?? '');
                                    $("td[data-field='warehouse']").text(d.warehouse?.name ?? '');
                                    $("td[data-field='metal']").text(d.metal ?? '');
                                    ...
                                    $("td[data-field='purity']").text(d.purity ?? '');
                                    $("td[data-field='metal_rate']").text(d.metal_rate ?? '');
                                    $("td[data-field='total_bead_amount']").text(d.total_bead_amount ?? '');
                                    $("td[data-field='total_stones_amount']").text(d.total_stones_amount ?? '');
                                    $("td[data-field='total_diamond_amount']").text(d.total_diamond_amount ?? '');
                                    $("td[data-field='total_metal_amount']").text(d.total_metal_amount ?? '');
                                    $("td[data-field='other_charges']").text(d.other_charges ?? '');
