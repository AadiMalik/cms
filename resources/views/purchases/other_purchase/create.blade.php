                        ...
                        <form id="saleForm" action="#" method="POST" enctype="multipart/form-data">
                            <div class="card-body" style="font-size: 14px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Bill No:<span
                                                    style="color:red;">*</span></label>
                                            <input type="date" name="bill_no" id="bill_no"
                                                class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select id="other_product_id" name="other_product_id" class="form-control show-tick"
                                            required>
