...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('diamond_sales', function (Blueprint $table) {
            $table->id();
            $table->string('diamond_sale_no')->nullable();
            $table->string('diamond_sale_date')->nullable();
    ...
    {
        Schema::dropIfExists('diamond_sales');
    }
};
